...
export default function Layout({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="flex h-screen bg-navy-800 sidebar-grain">
      {/* Mobile overlay */}
      {sidebarOpen && (
        <div
      ...
      >
        ...
        <nav className="flex-1 px-3 py-4 overflow-y-auto">
          <div className="relative">
            ...
            {/* Sliding pill — absolute, behind nav items */}
            {activeIndex >= 0 && (
              <div
      ...
      <div className="flex-1 flex flex-col min-w-0 lg:p-2">
        <div className="flex-1 flex flex-col min-w-0 overflow-hidden bg-slate-50 lg:rounded-2xl">
          ...
          <header className="lg:hidden flex items-center justify-between px-4 py-3 bg-white border-b border-slate-200">
            ...
            <p className="font-display text-sm font-semibold text-slate-800">Painel Admin</p>
            <div className="w-8" />
          </header>
